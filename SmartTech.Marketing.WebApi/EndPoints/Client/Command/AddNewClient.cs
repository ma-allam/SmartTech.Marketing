...
namespace SmartTech.Marketing.WebApi.EndPoints.Client.Command
{
    ...
    .WithActionResult<AddNewClientEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "AddNewClient", Description = "AddNewClient ", OperationId = "SmartTech.Marketing.WebApi.EndPoints.Client.Command.AddNewClient", Tags = new[] { "SmartTech.Marketing.WebApi.EndPoints.Client.Command" })]
