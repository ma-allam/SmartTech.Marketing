...
namespace SmartTech.Marketing.WebApi.EndPoints.Client.Query
{
    ...
    .WithActionResult<GetAddClientDataEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "GetAddClientData", Description = "GetAddClientData ", OperationId = "SmartTech.Marketing.WebApi.EndPoints.Client.Query.GetAddClientData", Tags = new[] { "SmartTech.Marketing.WebApi.EndPoints.Client.Query" })]
